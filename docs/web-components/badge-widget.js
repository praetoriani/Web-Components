...
class BadgeWidgetComponent extends HTMLElement {
    ...
    static get observedAttributes() {
        return ['iconname','iconcolor','shadow','glossy'];
    }
            ...
            <div id="SVGBatchBox" class="SVGBatchBox">
                <table class="BatchBoxTable" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td class="TabCellText">
                            <slot name="badgename"></slot>
                        </td>
                        <td class="TabCellInfo">
    ...
    */
    UpdateComponent() {
        ...
        if( this.iscolor == true ) {
            this.shadowRoot.getElementById('SVGiconHTML').style.fill = this.varIconColor;
